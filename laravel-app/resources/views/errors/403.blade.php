<x-app-layout>
    <div class="max-w-lg mx-auto px-4 py-20 text-center">
        <div class="mb-6">
            <span class="text-8xl font-bold text-danger/30">403</span>
        </div>
        <h1 class="text-2xl font-bold text-text-primary mb-3">アクセスが制限されています</h1>
        <p class="text-text-secondary mb-8">このページは管理者のみアクセス可能です。</p>
