...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" href="{{ asset('images/Vector.png') }}" type="image/png">
    ...
    <body class="font-sans text-text-primary antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-background">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-header-bg shadow-sm border border-border-light overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
        </div>
    </body>
